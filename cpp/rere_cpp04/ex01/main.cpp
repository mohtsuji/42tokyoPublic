...
{
	Dog basic;
	std::cout << RED"basic brain = " << basic.getBrain() << RES << std::endl;
	{
		//copy constructor
		Dog tmp = basic;
		std::cout << RED"tmp brain = " << tmp.getBrain() << RES << std::endl;
		//assignation
		Dog	assign;
		assign = basic;
		std::cout << RED"assign brain = " << assign.getBrain() << RES << std::endl;
	}
